...
export const PortfolioSection = (): JSX.Element => {
  return (
    <div className="flex w-full h-14 relative items-center gap-1.5 p-3">
      <div className="flex items-center gap-3 relative flex-1 grow">
        <img className="relative flex-[0_0_auto]" alt="Logo" src={logo} />

        <div className="relative flex-1 [font-family:'Inter',Helvetica] font-semibold text-white text-xl tracking-[0] leading-6">
          Token Portfolio
        </div>
      </div>
      ...
      <div className="inline-flex items-center gap-6 relative flex-[0_0_auto]">
        <Button className="px-2.5 py-1.5 bg-[#a9e851] rounded-[100px] shadow-[0px_0px_0px_1px_#1f6619,0px_1px_2px_#1f661966,inset_0px_0.75px_0px_#ffffff33] inline-flex items-center justify-center gap-1.5 relative flex-[0_0_auto] overflow-hidden h-auto hover:bg-[#98d147] cursor-pointer">
          ...
          <div className="mt-[-1.00px] text-black/70 font-medium">
            Connect WalletIcon
          </div>
        </Button>
      </div>
